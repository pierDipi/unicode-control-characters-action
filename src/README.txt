# find-unicode-control2

This script looks for non-printable unicode characters in all text files in a source tree.

```
usage: (depending on version of python you have installed)
python find_unicode_control2.py [-h] [-p {all,bidi}] [-v] [-c CONFIG] path [path ...]
OR
python3 find_unicode_control2.py [-h] [-p {all,bidi}] [-v] [-c CONFIG] path [path ...]
...
```
$ python find_unicode_control2.py -p bidi *.c
...
```
$ python find_unicode_control2.py -p bidi -d .
